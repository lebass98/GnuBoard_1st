...
class EnsureAdminOrderDetailPaymentQueryLayoutListener implements HookListenerInterface
{
    ...
    private const NOTICE_ID = 'nhnkcp_test_mode_notice';
    ...
    private function normalizeComponents(array $components): array
    {
        return array_map(function ($component) {
            if (
                is_array($component)
                && ! isset($component['id'])
                && $this->containsString($component, 'sirsoft-pay_nhnkcp.admin.test_mode_order_notice')
            ) {
    ...
    private function componentSignatures(array $component): array
    {
        ...
        foreach ([
            'sirsoft-pay_nhnkcp.admin.test_mode_order_notice',
            'sirsoft-pay_nhnkcp.admin.order_info_title',
            'sirsoft-pay_nhnkcp.admin.escrow_delivery_title',
        ] as $candidate) {
