...
use Plugins\Sirsoft\PayNicepayments\Listeners\RestoreLayoutExtensionsAfterUpdateListener;
...
class RestoreLayoutExtensionsAfterUpdateListenerTest extends PluginTestCase
{
    ...
    public function test_restores_soft_deleted_current_extension_for_prefixed_module_layout(): void
    {
        ...
        $extension = LayoutExtension::factory()
            ->overlay()
            ->fromPlugin('sirsoft-pay_nicepayments')
        ...
        $this->assertSame('sirsoft-pay_nicepayments', $restored->source_identifier);
        ...
        $this->assertStringContainsString('nicepay_test_map', $json);
    }
