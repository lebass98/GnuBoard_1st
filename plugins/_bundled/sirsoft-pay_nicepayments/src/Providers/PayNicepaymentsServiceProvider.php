...
namespace Plugins\Sirsoft\PayNicepayments\Providers;

use App\Extension\BasePluginServiceProvider;
use Illuminate\Cookie\Middleware\EncryptCookies;

class PayNicepaymentsServiceProvider extends BasePluginServiceProvider
{
    protected string $pluginIdentifier = 'sirsoft-pay_nicepayments';
